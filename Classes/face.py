...
class Face:
    ...
    def get_eye(self, x, y, radius, facecolor, edgecolor):
        """
    ...
    def get_mouth(self, x, y, width, height, linewidth, facecolor,
                  edgecolor, angle=0.0, theta1=0, theta2=360):
        """
    ...
    def smiling_face(self, x=0, y=0, eye_facecolor='black',
                     eye_edge_color=None, mouth_facecolor='black',
        ...
        smile = self.get_mouth(smile_x, smile_y, smile_width,
                               smile_height, 10, mouth_facecolor,
